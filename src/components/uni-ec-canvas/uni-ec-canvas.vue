<template>
    <canvas type="2d" v-if="isUseNewCanvas" class="ec-canvas" :canvas-id="canvasId" @init="init" @touchstart="touchStart" @touchmove="touchMove" @touchend="touchEnd"> </canvas>
    <canvas v-else class="ec-canvas" :canvas-id="canvasId" @init="init" @touchstart="touchStart" @touchmove="touchMove" @touchend="touchEnd"> </canvas>
</template>
        ...
        initByNewWay(callback) {
            ...
            query
                ...
                .exec((res) => {
                    ...
                    if (typeof callback === 'function') {
                        that.$curChart = callback(canvas, canvasWidth, canvasHeight, canvasDpr)
                    } else if (that.ec) {
